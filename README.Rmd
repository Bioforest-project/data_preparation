...
Launch the [`make.R`](https://github.com/cpiponiot/DataPrep/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/cpiponiot/DataPrep/blob/main/CONTRIBUTING.md).
